  ...
  if (!auth) {
    return (
      <div className="login">
        ...
        <button onClick={() => login((document.getElementById('username') as HTMLInputElement).value, (document.getElementById('password') as HTMLInputElement).value)}>Login</button>
      </div>
    );
  }
    ...
    <div className="App">
      ...
      <div className='content-wrapper'>
        <Routes>
          ...
          <Route path="/Report" element={<ProtectedRoute auth={auth} allowedRoles={['admin']}><Report /></ProtectedRoute>} />
          <Route path="/Upload" element={<ProtectedRoute auth={auth} allowedRoles={['admin']}><UploadStudent /></ProtectedRoute>} />
          <Route path="/Student" element={<ProtectedRoute auth={auth} allowedRoles={['admin']}><Student /></ProtectedRoute>} />
          <Route path="/Attendance" element={<ProtectedRoute auth={auth} allowedRoles={['teacher', 'admin']}><Attendance /></ProtectedRoute>} />
